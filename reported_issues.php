            ...
            foreach ($key as $_key => $value) {
              if ($_key != 'request_ID') {
                if ($_key == 'request_date_time') {
                  echo "<td><a href='address_issue.php?id={$key['request_ID']}&fromreport=1'>", date('l, F j, Y', $value), "</a></td>";
                } else {
                  echo "<td><a href='address_issue.php?id={$key['request_ID']}&fromreport=1'>", $value, "</a></td>";
                }
              }
            }
            echo "</tr>";
